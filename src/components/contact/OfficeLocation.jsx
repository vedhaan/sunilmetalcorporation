      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-stretch">
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+917925625146" className="text-ink/80 hover:text-oxide transition-colors">
                    (+91 79) 2562 5146
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <span className="shrink-0 w-9 h-9 rounded-full bg-bronze-core/10 border border-bronze-core/30 flex items-center justify-center">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 text-bronze-deep" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M4 6h16v12H4z M4 6l8 7 8-7" strokeLinejoin="round" />
                  </svg>
                </span>
                <div>
                  <p className="text-xs font-mono uppercase tracking-wide text-bronze-deep/70 mb-1">Fax</p>
                  <p className="text-ink/80">(+91 79) 2562 5147</p>
                </div>
              </div>
            </div>
          ...
          <motion.div
            ...
            className="relative min-h-[320px] md:min-h-full rounded-2xl overflow-hidden border border-ink/10 shadow-md"
          >
            <iframe
